...
public class T002AnotherEditText {
    ...
    public void checkEditTextPasswordIsCorrect() {
        ...
        Espresso.onView(editTextWithHint("Contraseña")).check(isLeftAlignedWith(editTextWithHint("charlie.doe")));
        Espresso.onView(editTextWithHint("Contraseña")).check(isRightAlignedWith(editTextWithHint("charlie.doe")));
        Espresso.onView(editTextWithHint("Contraseña")).check(isTopToBottomOf(editTextWithHint("charlie.doe")));
        ...
        Espresso.onView(editTextWithHint("charlie.doe")).check(hasDeclaredId());
    }
