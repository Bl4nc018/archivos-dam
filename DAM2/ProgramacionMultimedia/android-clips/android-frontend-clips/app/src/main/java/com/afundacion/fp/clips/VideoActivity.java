...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setOnClickListener(new View.OnClickListener() {
            ...
            // clipId fue inicializado más arriba, a traves los 'Extras'. .getCurrentPosition() devuelve el milisegundo actual del vídeo
    ...
    private void sendAppearancesRequest(int clipId, int milliseconds) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest( // Instanciamos el array request.
                Request.Method.GET, // Indicamos el método HTTP Request.Method.GET
                Server.name + "/clips/" + clipId + "/appearances?milliseconds=" + milliseconds,  // Indicamos la URL apropiada
                null,
                new Response.Listener<JSONArray>() {   //Si la petición es exitosa:
                    @Override
                ...
                new Response.ErrorListener() { // Si la petición falla:
                    @Override
        ...
        // Añadimos la petición a la cola de red
