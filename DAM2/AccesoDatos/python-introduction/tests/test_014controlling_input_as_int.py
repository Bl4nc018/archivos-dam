...
"""
    ...
    def test_output_with_correct_and_incorrect_answers(self):
        ...
        self.__verify_question2_output_content(str(incorrect_value), "Vaya, la respuesta es errónea")
        self.__verify_question2_output_content(str(correct_value), "Respuesta correcta")
