...
public class T019Coin {
    ...
    public void testOutputMessages() {
        ...
        try {
            Class cls = Class.forName("Coin");
            Object instance = cls.getDeclaredConstructor(int.class).newInstance(num);
            Method method = cls.getDeclaredMethod("flipCoin");
            ...
            for (int i = 0; i < 100; i++) {
                ...
                } else if (output.equals("Has tirado al aire la moneda y ha salido cara. Ganaste " + num + " euros")) {
