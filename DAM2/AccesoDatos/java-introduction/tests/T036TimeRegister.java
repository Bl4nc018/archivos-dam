...
public class T036TimeRegister {
    ...
    public void testMethodException() {
        try {
            ...
            Method method = cls.getDeclaredMethod("addHours", short.class, short.class);
    ...
    private void testCase(List<HoursInnerTestClass> toRecord) throws FileNotFoundException {
        try {
            ...
            Method methodSaveJson = cls.getDeclaredMethod("produceJSON");
        ...
        assertEquals(calculateTotalTime(toRecord), object.getInt("totalHours"));
