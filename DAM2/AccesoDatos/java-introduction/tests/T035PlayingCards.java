...
public class T035PlayingCards {
    ...
    public void testConstructorException() throws FileNotFoundException {
        ...
        try {
            Class cls = Class.forName("CardDistributer");
            Object instance = cls.getDeclaredConstructor(short.class, short.class).newInstance((short) (4+1), (short) 8);
        ...
        try {
            Class cls = Class.forName("CardDistributer");
            Object instance = cls.getDeclaredConstructor(short.class, short.class).newInstance((short) 4, (short) 8);            assertTrue(true);
        } catch (ClassNotFoundException |NoSuchMethodException| IllegalAccessException | InstantiationException e) {
            fail("Problemas genéricos al instanciar la clase");
        } catch (InvocationTargetException  e) {
    ...
    private void testCase(short numPlayers, short numCards) throws FileNotFoundException {
        try {
            ...
            Method generateJSON = cls.getDeclaredMethod("produceJSON");
