...
class WallAPIPaginationEndpointTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        file = open("test_024older_than.json", "w")
        file.write('[{"model": "wallrest04app.entry", "pk": 1, "fields": {"title": "Title1", "content": "'+self.r1+'", "publication_date": "2022-07-13T10:58:27Z"}}, {"model": "wallrest04app.entry", "pk": 2, "fields": {"title": "Title2", "content": "'+self.r2+'", "publication_date": "2022-07-13T11:04:50Z"}}, {"model": "wallrest04app.entry", "pk": 3, "fields": {"title": "Title3", "content": "'+self.r3+'", "publication_date": "2022-07-13T11:11:55Z"}}]')
        file.close()
    ...
    def __test_with_server_alive(self, block):
        def run_server():
            proc = subprocess.Popen("python manage.py testserver ../../tests/test_024older_than.json --noinput", creationflags=subprocess.CREATE_NEW_PROCESS_GROUP, cwd=context.WALL_API_ROOT)
            time.sleep(4)
