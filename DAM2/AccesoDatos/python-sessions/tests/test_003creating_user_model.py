...
class IdeAPICustomUserModelTestCase(unittest.TestCase):
    ...
    def test_db_was_migrated(self):
        ...
        command = 'sqlite3.exe apis/IdeAPI/db.sqlite3 "SELECT COUNT(email) FROM idearest04app_customuser WHERE id=-1"'
    ...
    def __expected_lines_content(self):
        ...
        return [
            ...
            {"line": "models.CharField(max_length=280, unique=True)", "found": False},
            {"line": "models.CharField(max_length=300)", "found": False},
