...
class IdeAPIUserSessionModelTestCase(unittest.TestCase):
    ...
    def test_db_was_migrated(self):
        ...
        command = 'sqlite3.exe apis/IdeAPI/db.sqlite3 "SELECT COUNT(creator_id) FROM idearest04app_usersession WHERE id=-1"'
    ...
    def __expected_lines_content(self):
        ...
        return [
            ...
            {"line": "models.CharField(unique=True, max_length=25)", "found": False},
        ]
