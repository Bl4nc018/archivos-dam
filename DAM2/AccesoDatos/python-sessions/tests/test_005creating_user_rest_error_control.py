...
class IdeAPIRegisterNotHappyPathTestCase(unittest.TestCase):
    ...
    def test_missing_param_password(self):
        def test_body():
            request_body_missing_param = {
                "email": "test_" + str(time.time()) + "@test.co.uk",
                "username": "Test User",
            }
            self.__assert_post_endpoint("v1/users", request_body_missing_param, {"error": "Missing parameter in body request"}, 400)
    ...
    def test_email_not_valid_due_to_missing_character(self):
        def test_body():
            ...
            self.__assert_post_endpoint("v1/users", request_body_invalid_email, {"error": "Not valid email"}, 400)
    ...
    def test_email_not_valid_due_to_length_restriction(self):
        def test_body():
            ...
            self.__assert_post_endpoint("v1/users", request_body_short_email, {"error": "Not valid email"}, 400)
    ...
    def test_already_registered(self):
        ...
        command = 'sqlite3.exe apis/IdeAPI/db.sqlite3 "INSERT INTO idearest04app_customuser (email, username, encrypted_password) VALUES (\'' + valid_email + '\', \'Test User\', \'$2b$12$l2NvEv5Fm7abtLDhWNyKu.pL3orDvp700e8vaLJPfTDKnptWsflV.\')"'
        ...
        def send_request():
            ...
            self.__assert_post_endpoint("v1/users", request_body, {"error": "User already registered"}, 409)
