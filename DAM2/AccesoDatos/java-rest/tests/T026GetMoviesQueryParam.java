...
public class T026GetMoviesQueryParam {
    ...
    private void testResultContainsAllMoviesAndOrderIsCorrectFor(int index) {
        try {
            ...
            String queryParam = "orderByYearDesc";
            JSONArray result = getUrl("http://localhost:8104/movies?"+queryParam+"=true");
            assert(result != null);
    ...
    private static Comparator<TestMovie> appropriateComparator() {
        String desiredComparison = "orderByYearDesc";
